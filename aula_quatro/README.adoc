...
- link:codigos/Jogador.java[Jogador]
- link:codigos/Time.java[Time]
- link:codigos/Principal.java[Principal]

Exemplos práticos (composição):

- link:codigos/Jogador2.java[Jogador]
- link:codigos/Time2.java[Time]
- link:codigos/Principal2.java[Principal]

= Associações e Classes Associativas / Ordinárias

Exemplos práticos:

- link:codigos/Medico.java[Medico]
- link:codigos/Consulta.java[Consulta]
- link:codigos/Paciente.java[Paciente]
- link:codigos/Principal3.java[Principal]
